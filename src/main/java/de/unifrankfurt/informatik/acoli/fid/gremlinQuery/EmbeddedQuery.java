...
public class EmbeddedQuery {
	...
	public void removeOrphanHits() {
		...
		String deleteOrphanHitNeighbors = 	
		  ...
		  + ".not(has('"+GWriter.Model+"','"+ModelType.ONTOLEX.name()+"'))"
	...
	/**
	 * Generic query which has a map <String, Long> as result
	 * @param query
	...
	/**
	 * Generic query which has a Integer or Long value as result
	 * @param query
	 * @return List of vertices
	 */
	...
	public HashSet<String> getBLLResultPath(ResourceInfo resourceInfo, ModelMatch modelMatch, FileResult fileResult) {
		...
		if (fileResult.isUrl()) {
		  ...
		  "has('"+GWriter.ClassModel+"','"+ModelType.BLL+"')."+
