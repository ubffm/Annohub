...
public class LinghubResource implements Serializable {
	...
	public LinghubResource() {}
	
	public LinghubResource (String dcLanguages, String dcFormat, String dctType) {
	...
	public int getHashCode() {
		...
		if (hashString.startsWith("123456789101112131415")) return 0;
		else 
