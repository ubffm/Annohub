...
public static void main (String [] args) {
	...
	Producer producer = new Producer();
 	ResourceInfo resourceInfo = new ResourceInfo("http://acoli.cs.uni-frankfurt.de/resources/olia/olia.owl","http://acoli.cs.uni-frankfurt.de/resources/olia","http://linghub/dummy/dataset", ResourceFormat.RDF);
	producer.sendResourceInfo(resourceInfo);
	
	
	Consumer consumer = new Consumer(Executer.MQ_Default);
	consumer.receiveResourceInfo();
